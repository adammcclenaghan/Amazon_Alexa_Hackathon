...
var questions = [
    ...
    {
        "In computer architecture, how many bytes are there in a word?": [
            "two"
    ...
    {
        "How many values can a single binary digit represent?": [
            "two"
        ]
    },
    {
        "How many bytes does the long data type in java use?": [
            "eight"
        ]
    },
    {
        "How many bytes does the integer data type in java use?": [
            "four"
        ]
    },
    {
        "Which letter represents the highest value a single hexadecimal value can attain?": [
            "f"
        ]
    },
